...
class EndpointMap:
    ...
    batch_upload: str = "/v1/projects/{project_id}/sources/{source_id}/documents:batch"
    create_sync: str = "/v1/sources/{source_id}/syncs"
    update_sync: str = "/v1/sources/{source_id}/syncs/{sync_id}"
