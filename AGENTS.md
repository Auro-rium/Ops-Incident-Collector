...
- The collector owns discovery, path policy, filtering, secret redaction, metadata extraction, local export, and Core sync.
...
- Phase 1 excludes LangGraph, XML prompt libraries, daemon mode, RAG chunk candidates, and local incident diagnosis.
